#!/bin/bash
#SBATCH --job-name=rtrrl_lru_NoisyStatelessCartPoleEasy
#SBATCH --partition=a3
#SBATCH --array=1-3
...
#SBATCH --output=logs/slurm/rtrrl_lru_NoisyStatelessCartPoleEasy_%A_%a.out
#SBATCH --chdir=/home/ciaran_sakana_ai/RTRRL-AAAI25
#SBATCH --export=ALL,JAX_PLATFORMS=cpu

ENV_NAME=NoisyStatelessCartPoleEasy
RNN_MODEL=lru
SEED=$SLURM_ARRAY_TASK_ID
OUT_DIR="logs/runs/${RNN_MODEL}_${ENV_NAME}_seed${SEED}_job${SLURM_ARRAY_JOB_ID}"
STDOUT_LOG="logs/slurm/rtrrl_${RNN_MODEL}_${ENV_NAME}_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.out"
...
echo "${ENV_NAME}_${RNN_MODEL},${SEED},${SLURM_ARRAY_JOB_ID},${SLURM_ARRAY_TASK_ID},${OUT_DIR},${STDOUT_LOG}" >> "$MANIFEST"
