#!/bin/bash
#SBATCH --job-name=rtrrl_lru_NoisyStatelessPendulumEasy
#SBATCH --partition=a3
#SBATCH --array=1-3
...
#SBATCH --output=logs/slurm/rtrrl_lru_NoisyStatelessPendulumEasy_%A_%a.out
#SBATCH --chdir=/home/ciaran_sakana_ai/RTRRL-AAAI25
#SBATCH --export=ALL,JAX_PLATFORMS=cpu

ENV_NAME=NoisyStatelessPendulumEasy
RNN_MODEL=lru
